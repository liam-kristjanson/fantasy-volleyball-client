import { mdiAccount, mdiHandball, mdiMedal, mdiMenu, mdiSwordCross, mdiVolleyball, mdiWrench } from "@mdi/js";
    ...
    return (
        <>
            <nav className="fixed-top bg-white d-flex justify-content-between p-3 shadow">
                <a key="home" className="fw-bold fs-2 text-primary pe-auto text-decoration-none hover-underline hover-pointer" onClick={() => {navigate('/')}}><Icon className="mb-1 me-2" path={mdiVolleyball} size={1.5} />FVB Admin</a>
