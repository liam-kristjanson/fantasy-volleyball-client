                            ...
                            {props.isLoading || !props.teamWeekStats ? (
                                ...
                                <>
                                    <tr>
                                        ...
                                        <td>
                                            {(props.teamWeekStats?.lineupStats?.S?.points ?? 0).toFixed(1) ?? "N/A"}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {(props.teamWeekStats?.lineupStats?.OH1?.points ?? 0).toFixed(1) ?? "N/A"}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {(props.teamWeekStats?.lineupStats?.OH2?.points ?? 0).toFixed(1) ?? "N/A"}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {(props.teamWeekStats?.lineupStats?.OH3?.points ?? 0).toFixed(1) ?? "N/A"}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {(props.teamWeekStats?.lineupStats?.M1?.points ?? 0).toFixed(1) ?? "N/A"}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {(props.teamWeekStats?.lineupStats?.M2?.points ?? 0).toFixed(1) ?? "N/A"}
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {(props.teamWeekStats?.lineupStats?.L?.points ?? 0).toFixed(1) ?? "N/A"}
                                        </td>
                                    </tr>
